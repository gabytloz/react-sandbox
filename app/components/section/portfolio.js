...
export default class Portfolio extends React.Component {
    ...
    render() {
      return <section id="portfolio">
        ...
        <div id="portfolio_slider" className="carousel slide" data-ride="">
          <div className="carousel-inner">
            <div className="item active">
              <a href="http://cruzrojatijuana.org.mx/" title="Visit website" target="_blank" id="cr-img" className="portfolio_img laptop external">Image of the Mexican Red Cross' website <span className="visit_web">Visit website</span></a>
              <div className="container">
                ...
                <div className="row">
                  <div className="col-xs-12 col-sm-5">
                    ...
                    <a href="contact" title="Contact me" className="button blue">Contact me</a>

                  </div>
                  <div className="col-xs-12 col-sm-6 col-sm-offset-1 text-right">
                    <h4>My <em>contribution</em></h4>
                    <span className="contribution">layout coding</span>
            ...
            <div className="item">
              <a href="http://evottek.co/" title="Visit website" target="_blank" id="evo-img" className="portfolio_img devices external">Image of Evottek's website <span className="visit_web">Visit website</span></a>
              <div className="container">
            ...
            <div className="item">
              <a href="https://www.mdkdelvalle.com/" title="Visit website" target="_blank" id="mdk-img" className="portfolio_img devices external">Image of Moo Duk Kwan Del Valle's website <span className="visit_web">Visit website</span></a>
              <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-6 col-sm-offset-1 text-right">
                    <h4>My <em>contribution</em></h4>
                    <span className="contribution">web design</span> <span className="contribution">copy</span>  <span className="contribution">layout coding</span>
            ...
            <div className="item">
              <a href="http://dev.vagui.com/elsociable/" title="Visit website (cancelled)" target="_blank" id="sociable-img" className="portfolio_img laptop external">Image of El sociable's website <span className="visit_web">Visit website</span></a>
              <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-6 col-sm-offset-1 text-right">
                    <h4>My <em>contribution</em></h4>
                    <span className="contribution">web design</span> <span className="contribution">logo design</span> <span className="contribution">layout coding</span>
                    <p>This project was pretty much just an idea that was becoming something else. Additionally to my design skills, most of my work was to figure out how could the business work, finding the "but"s and the "how"s. Sadly the project was cancelled.</p>
                    <ul className="skills">
                      <li>html</li><li>
                        css</li><li>
                        jQuery</li>
            ...
            <div className="item">
              <a href="http://dev.vagui.com/adell/" title="Visit inspirational website" target="_blank" id="adell-img" className="portfolio_img devices external">Image of Adell's inspirational website <span className="visit_web">Visit website</span></a>
              <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-6 col-sm-offset-1 text-right">
                    <h4>My <em>contribution</em></h4>
                    <span className="contribution">web design</span> <span className="contribution">layout coding</span>
          ...
          <ol className="carousel-indicators">
            <li data-target="#portfolio_slider" data-slide-to="0" className="active"></li>
            <li data-target="#portfolio_slider" data-slide-to="1"></li>
            <li data-target="#portfolio_slider" data-slide-to="2"></li>
            <li data-target="#portfolio_slider" data-slide-to="3"></li>
            <li data-target="#portfolio_slider" data-slide-to="4"></li>
          </ol>
          <a href="#portfolio_slider" title="Previous website" className="left carousel-control" role="button" data-slide="prev">
            <span className="icon nav-arrow-left"></span>
            Anterior
          </a> { /* .left.carousel-control  */ }
          <a href="#portfolio_slider" title="Next website"  className="right carousel-control"  role="button" data-slide="next">
          <span className="icon nav-arrow-right"></span>
            Siguiente
          </a> { /* .right.carousel-control  */ }
        </div> { /* #portfolio_slider /.carousel  */ }
      </section>
    }
}
