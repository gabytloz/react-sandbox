...
export default class ContactForm extends React.Component {
  ...
  render() {
    ...
    const emailErrorMessage = <p className="error">The email doesn't seem to be valid</p>
    const nameErrorMessage  = <p className="error">Name seems to be too short</p>
    const messageErrorMessage  = <p className="error">Your message needs to be a little longer</p>
